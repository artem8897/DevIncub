...
public class Query {
    ...
    public static final String SQL_SELECT_USER_BY_EMAIL = "SELECT id,password,email,usertype,status FROM mydb.user WHERE email = ? ;";
    ...
    public static final String SQL_SELECT_LIMIT_TRAINERS = "SELECT work_experience,name,training_type,trainer_id FROM trainer_information LIMIT ?,?";
    ...
    public static final String SQL_SELECT_LIMIT_INFORMATION_BY_TRAINER = "SELECT name,second_name,sex,weight,height,information_id FROM personal_information JOIN user_trainer ON personal_information.information_id = user_trainer.user_id WHERE trainer_id = ? ORDER BY NAME  LIMIT ?,?";
    ...
    public static final String SQL_UPDATE_USER_TYPE =     "UPDATE user SET usertype = ? WHERE id = ?";
    ...
    public static final String SQL_UPDATE_EXERCISE =     "UPDATE JOURNAL     SET MARK = ? WHERE ID_STUDENT_COURSE = ?";
    ...
    public static final String SQL_CALCULATE_PRICE_FOR_TRAININGS = "SELECT (price * discounts.discount_value)/100  FROM discounts JOIN personal_information ON discounts.discount_id = personal_information.status_id, centerces_price WHERE personal_information.information_id = ? AND training_amount = ?;";
