...
public interface TrainerService {
    ...
    boolean createTrainer(int userId, String name,int experience, String trainingType, Map map) throws LogicException;
    ...
    boolean updateTrainerInformation(int trainerId,String name, int workExperience, String trainingType, Map map) throws LogicException;
