...
public interface StudentService {
    ...
    boolean addInformation(int userId, String name,String secondName,String sex, int weight, int height, Map map) throws LogicException;
    ...
    boolean updateUserInformation(int userId, String name,String secondName,String sex, int weight, int height, Map map) throws LogicException;
