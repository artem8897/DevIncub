...
public class ParamName {
    ...
    public static final String PARAM_NAME_CARBOHYDRATES = "carbohydrates";
    ...
    public static final String PARAM_NAME_CONFIRMED_PASSWORD2 = "password2";
    ...
    public static final String TRAINING_AMOUNT = "training_amount";
