...
public class PathName {
    ...
    public static final String PATH_PAGE_ALL_USERS_TRAINING = "path.page.all_users_training";
    public static final String PATH_PAGE_ALL_USERS_REVIEW = "path.page.all_users_review";
    public static final String PATH_PAGE_CHOOSE_STUDENT = "path.page.choosing_user_for_create_training";
    public static final String PATH_PAGE_ALL_TRAINERS = "path.page.all_trainers_information";
    public static final String PATH_PAGE_ALL_REVIEWS = "path.page.all_reviews";
    public static final String PATH_PAGE_CHOOSE_TRAINER = "path.page.choose_trainer_and_pay";
    public static final String PATH_PAGE_PRICE_PAY = "path.page.price_pay";
    public static final String PATH_TRAINER_EDITION_USER = "path.page.trainer_edition";
